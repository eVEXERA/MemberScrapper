...
while True:
    ...
    print(lg+'[4] Update your Scrapper'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 1255191 , '2c8b8fb9296c85e7c3f1abaea9dd8a74')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 1255191 , '2c8b8fb9296c85e7c3f1abaea9dd8a74')
                client.connect()
        ...
        try:
            # https://raw.githubusercontent.com/Cryptonian007/MemberScrapper/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/Cryptonian007/MemberScrapper/main/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                if os.name == 'nt':
                    os.system('del adding.py')
                    os.system('del termux.py')
                else:
                    os.system('rm adding.py')
                    os.system('rm termux.py')
                #os.system('del scraper.py')
                os.system('curl -l -O https://raw.githubusercontent.com/Cryptonian007/MemberScrapper/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/Cryptonian007/MemberScrapper/main/manager.py')
